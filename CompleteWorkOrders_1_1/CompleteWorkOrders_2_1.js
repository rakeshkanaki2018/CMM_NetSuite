...
function completeWorkOrders_SS() {
    try {
        ...
        params["custscript_gem_complete_wo_id"] = rec_id;

        //nlapiLogExecution('DEBUG', 'Params', params);

        nlapiScheduleScript('customscript_gem_ss_complete', 'customdeploy_gem_ss_complete', params);
        return "T";
    } catch (e) {
...
function closeWorkOrders_SS() {
    try {
        ...
        var params = new Array();
        params["custscript_gem_close_wo_id"] = rec_id;

        //nlapiLogExecution('DEBUG', 'Params', params);

        nlapiScheduleScript('customscript_gem_ss_close', 'customdeploy_gem_ss_close', params);
        return "T";
